...
const postCreateClubEvent = async (clubId, eventName, roomId, date, startTime, endTime, details, banner, link) => {
...
const postClassroom = async (classId, className, capacity, examCapacity, property, block, classType) => {
...
const postLesson = async (lectureCode, lectureName, department, grade, session, instructorId) => {
