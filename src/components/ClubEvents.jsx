...
const ClubEvents = ({ events }) => {
  ...
  const formattedDate = selectedTime
    ? `${moment(selectedTime?.start).format("DD MMMM dddd HH:mm")} - ${moment(
        selectedTime?.end
      ).format("HH:mm")}`
  ...
  return (
    <Container className="bg-light rounded-4 p-1 ps-3">
      <Row className="justify-content-start align-items-center">
        <Col md="auto">
          <h3 className="sticky-top bg-light">
            Henüz Gerçekleşmeyen Kulüp Etkinlikleri
          </h3>
        </Col>
        <Col md="auto">
      ...
      <Row>
        {events.length === 0 && (
          <p className="text-center fw-semibold mt-3">
            Yakında gerçekleşecek etkinlik bulunmamakta.
          </p>
        )}
            ...
            >
              ...
              <Card.Body>
                <Row>
                  <Col
                    md={3}
                    className="fw-bold fs-2 d-flex align-items-center border-end"
                  >
                    {event.clubRoomName}
                  </Col>
                  <Col md={9}>
                    <div className="twinkle-star-regular text-center">
        ...
        <Modal size="xl" show={showModal} onHide={handleCloseModal} centered>
          <Modal.Header closeButton>
            <Modal.Title>
              {
                <Image
                  src={`${baseUrl2}${selectedEvent.clubLogo}`}
                  style={{ width: "80px" }}
                />
              }
            </Modal.Title>
          ...
          <Modal.Body>
            <p>
              <strong>Etkinlik adı:</strong> {selectedEvent.title}
            </p>
            <p>
            ...
            <p>
              <strong>Yer:</strong> {selectedEvent.clubRoomName}
            </p>
            <Row>
              <Col md="auto">
      ...
      >
        ...
        <Modal.Body>
          <Form>
            ...
            <Row className="align-items-center mt-2">
              <Col>
                <Form.Group controlId="formEventLink">
                  <Row className="align-items-center">
                    <Col md="auto">
                      <Form.Label>
                        <strong>Etkinlik katılım formu linki:</strong>
                      </Form.Label>
                    </Col>
                    <Col md={8}>
                      <Form.Control
              ...
              <Col md={4}>
                <strong>Tarih ve saat: </strong> {formattedDate}
              </Col>
            </Row>
            ...
            <Form.Group controlId="formEventImage">
              <Row className="d-flex justify-content-start w-50 align-items-center mt-2">
                <Col md={3}>
                  {" "}
                  <Form.Label>
                    <strong>Etkinlik afişi: (Zorunlu değil)</strong>
                  </Form.Label>
                </Col>
                <Col md={9}>
                  {" "}
        ...
        <Row className="px-1">
          <Col md={6} className="scrollable">
            {" "}
            <ClassesList setSelectedCard={setSelectedCard} />
          </Col>
          <Col md={6}>
            {" "}
            <ClubEventCreateCalendar
